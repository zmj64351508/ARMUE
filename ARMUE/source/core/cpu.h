...
typedef uint32_t (*cpu_get_pc_func_t)(struct cpu_t *cpu);
typedef void (*cpu_set_pc_func_t)(uint32_t val, struct cpu_t *cpu);
...
typedef struct cpu_t
{
    ...
    cpu_get_pc_func_t get_raw_pc;
    cpu_set_pc_func_t set_raw_pc;
